...
/* harmony export */ });
/* harmony import */ var _env_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./env.js */ "../../nova/node_modules/@vue/devtools-api/lib/esm/env.js");
...
/* harmony import */ var _proxy_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./proxy.js */ "../../nova/node_modules/@vue/devtools-api/lib/esm/proxy.js");
/* harmony import */ var _time_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./time.js */ "../../nova/node_modules/@vue/devtools-api/lib/esm/time.js");
...
/* harmony export */ });
/* harmony import */ var _const_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./const.js */ "../../nova/node_modules/@vue/devtools-api/lib/esm/const.js");
/* harmony import */ var _time_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./time.js */ "../../nova/node_modules/@vue/devtools-api/lib/esm/time.js");
...
/* harmony import */ var _util_filled__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../util/filled */ "../../nova/resources/js/util/filled.js");
/* harmony import */ var _util_escapeUnicode__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../util/escapeUnicode */ "../../nova/resources/js/util/escapeUnicode.js");
  ...
  methods: {
    ...
    fillAttachmentDraftId: function fillAttachmentDraftId(formData) {
      ...
      var _attribute$split = attribute.split('['),
        ...
        nested = _arrayLikeToArray(_attribute$split2).slice(1);
...
/* harmony import */ var _inertiajs_inertia__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @inertiajs/inertia */ "../../nova/node_modules/@inertiajs/inertia/dist/index.js");
/* harmony import */ var _util_filled__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../util/filled */ "../../nova/resources/js/util/filled.js");
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
function ownKeys(e, r) { var t = Object.keys(e); if (Object.getOwnPropertySymbols) { var o = Object.getOwnPropertySymbols(e); r && (o = o.filter(function (r) { return Object.getOwnPropertyDescriptor(e, r).enumerable; })), t.push.apply(t, o); } return t; }
function _objectSpread(e) { for (var r = 1; r < arguments.length; r++) { var t = null != arguments[r] ? arguments[r] : {}; r % 2 ? ownKeys(Object(t), !0).forEach(function (r) { _defineProperty(e, r, t[r]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t)) : ownKeys(Object(t)).forEach(function (r) { Object.defineProperty(e, r, Object.getOwnPropertyDescriptor(t, r)); }); } return e; }
function _defineProperty(e, r, t) { return (r = _toPropertyKey(r)) in e ? Object.defineProperty(e, r, { value: t, enumerable: !0, configurable: !0, writable: !0 }) : e[r] = t, e; }
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  created: function created() {
    var _this = this;
    this.removeOnNavigationChangesEvent = _inertiajs_inertia__WEBPACK_IMPORTED_MODULE_1__.Inertia.on('before', function (event) {
  ...
  methods: _objectSpread(_objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_0__.mapMutations)(['allowLeavingForm', 'preventLeavingForm', 'triggerPushState', 'resetPushState'])), {}, {
    /**
    ...
    handlePreventFormAbandonmentOnInertia: function handlePreventFormAbandonmentOnInertia(event) {
      ...
      this.handlePreventFormAbandonment(function () {
        ...
        _inertiajs_inertia__WEBPACK_IMPORTED_MODULE_1__.Inertia.ignoreHistoryState = true;
        event.preventDefault();
        event.returnValue = '';
        _this3.removeOnNavigationChangesEvent = _inertiajs_inertia__WEBPACK_IMPORTED_MODULE_1__.Inertia.on('before', function (event) {
    ...
    handleProceedingToPreviousPage: function handleProceedingToPreviousPage() {
      ...
      _inertiajs_inertia__WEBPACK_IMPORTED_MODULE_1__.Inertia.ignoreHistoryState = false;
      this.removeOnBeforeUnloadEvent();
    ...
    proceedToPreviousPage: function proceedToPreviousPage(url) {
      if (this.navigateBackUsingHistory && window.history.length > 1) {
        window.history.back();
      } else if (!this.navigateBackUsingHistory && (0,_util_filled__WEBPACK_IMPORTED_MODULE_2__["default"])(url)) {
        Nova.visit(url, {
          replace: true
        });
      } else {
  ...
  computed: _objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_0__.mapGetters)(['canLeaveForm', 'canLeaveFormToPreviousPage']))
});
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    setInitialValue: function setInitialValue() {
      this.previewUrl = this.field.value ? '/storage/' + this.field.value : null;
      this.file = null;
    },
    fill: function fill(formData) {
      if (this.file) {
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createBlock)(_component_DefaultField, {
    ...
    field: (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
      return [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("image preview "), _ctx.previewUrl ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_1, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("img", {
        src: _ctx.previewUrl,
        alt: "Preview",
        "class": "rounded",
        style: {
      ...
      }, null, 8 /* PROPS */, _hoisted_2)])) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("File input"), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("input", {
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("td", _hoisted_1, [$props.field.value ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("img", {
    key: 0,
    src: '/storage/' + $props.field.value,
    alt: "Product",
    "class": "rounded",
    style: {
      "width": "50px",
  ...
  }, null, 8 /* PROPS */, _hoisted_2)) : ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("span", _hoisted_3, "—"))]);
}
...
Nova.booting(function (app, store) {
  app.component('index-image-preview-field', _components_IndexField__WEBPACK_IMPORTED_MODULE_0__["default"]);
  app.component('detail-image-preview-field', _components_DetailField__WEBPACK_IMPORTED_MODULE_1__["default"]);
  app.component('form-image-preview-field', _components_FormField__WEBPACK_IMPORTED_MODULE_2__["default"]);
});
...
/* harmony import */ var C_Users_vinuv_OneDrive_Sri_Lanka_Institute_of_Information_Technology_Laravel_laravel_nova_nova_demo_nova_foundation_new_nova_components_ImagePreviewField_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./node_modules/vue-loader/dist/exportHelper.js */ "./node_modules/vue-loader/dist/exportHelper.js");




;
const __exports__ = /*#__PURE__*/(0,C_Users_vinuv_OneDrive_Sri_Lanka_Institute_of_Information_Technology_Laravel_laravel_nova_nova_demo_nova_foundation_new_nova_components_ImagePreviewField_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_2__["default"])(_DetailField_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__["default"], [['render',_DetailField_vue_vue_type_template_id_0224618e__WEBPACK_IMPORTED_MODULE_0__.render],['__file',"resources/js/components/DetailField.vue"]])
/* hot reload */
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkvendor_image_preview_field"] = self["webpackChunkvendor_image_preview_field"] || [];
